...
[size=4]Installation instructions[/size]

1. Install [[url=https://www.nexusmods.com/site/mods/21]Unity Mod Manager[/url]] and point it at your Derail Valley install.
2. Download the zip from the Files tab.
3. Drop the zip onto UMM's Mods tab or unpack it into:
[code]*path to game*/Derail Valley/Mods/[/code]
giving you:
[code]*path to game*/Derail Valley/Mods/WagonDestination/[/code]
4. Start the game. The mod shows up in UMM's mod list as "Wagon Destination".


[size=4]Main features[/size]

- Destination track shown on both info plates of every car that a job references.
- Shunting-aware: for a car moved through several tracks, the line shows the last track the job leaves it on.
...
- [[url=https://www.nexusmods.com/site/mods/21]Unity Mod Manager[/url]] 0.27 or newer

[size=4]Source code[/size]

[[url=https://github.com/Alexand3r/dv-wagon-destination]GitHub - dv-wagon-destination[/url]]

[size=4]Shout outs[/size]

- Altfuture, for a game worth modding.
- Andreas Pardeike, for [[url=https://github.com/pardeike/Harmony]Harmony[/url]]
